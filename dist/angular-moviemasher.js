...
(function(){
  ...
  function LodashFactory($window) {  
    ...
    return $window.csvtojson;
  }
  
  // Define dependencies
  LodashFactory.$inject = ['$window'];
  module.service('csvtojson', LodashFactory)
  module.directive('ammUi', ['$amm', 'amm_resources', '$resource', function($amm, amm_resources, $resource){
    return {
      templateUrl: 'views/ui.html',
      restrict: 'AEC',
      controller: ['$scope', '$window', '$interval', 'amm_resources', '$http',
        function($scope, $window, $interval, amm_resources, $http) {
